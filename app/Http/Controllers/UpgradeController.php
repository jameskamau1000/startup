...
Route::post('panel/admin/pwa','AdminController@pwa');",
		...
		if ($version == '4.8') {
			...
			//============== Files ================//
			$files = [
				'composer.json' => $ROOT, //v4.8
				'composer.lock' => $ROOT, //v4.8

				'paypal.php' => $CONFIG, //v4.8

				'web.php' => $ROUTES, //v4.8

				'AdminController.php' => $CONTROLLERS, //v4.8
				'DonationsController.php' => $CONTROLLERS, //v4.8
				'PayPalController.php' => $CONTROLLERS, //v4.8

				'blog.blade.php' => $VIEWS_INDEX, //v4.8

				'admin-styles.css' => $PUBLIC_CSS, //v4.8
				'styles.css' => $PUBLIC_CSS, //v4.8
			];

			$filesAdmin = [
				'layout.blade.php' => $VIEWS_ADMIN, //v4.8
				'pwa.blade.php' => $VIEWS_ADMIN, //v4.8
				'paypal-settings.blade.php' => $VIEWS_ADMIN, //v4.8
				'donations.blade.php' => $VIEWS_ADMIN, //v4.8
			];
		...
		if ($version == '4.9') {
			...
			$files = [
				...
				'AdminController.php' => $CONTROLLERS, //v4.9

				'core.min.js' => $PUBLIC_JS, //v4.9
				'install-app.js' => $PUBLIC_JS, //v4.9

				'app.blade.php' => $VIEWS, //v4.9
				'footer.blade.php' => $VIEWS_INCLUDES, //v4.9
				'javascript_general.blade.php' => $VIEWS_INCLUDES, //v4.9
			];

			$filesAdmin = [
				'theme.blade.php' => $VIEWS_ADMIN, //v4.9
				'pwa.blade.php' => $VIEWS_ADMIN, //v4.9
				'limits.blade.php' => $VIEWS_ADMIN, //v4.9
			];
			...
			if ($copy == false) {
				...
				//============== QUERY SQL =======================
				if (!Schema::hasColumn('admin_settings', 'status_pwa')) {
					Schema::table('admin_settings', function ($table) {
						$table->boolean('status_pwa')->index('type')->default(0);
					});
				}
				//============== END QUERY SQL ===================
		...
		if ($version == '5.0') {
			...
			//============== Files ================//
			$files = [
				'captcha.php' => $CONFIG,//yes

				'web.php' => $ROUTES,//yes

				'AdminController.php' => $CONTROLLERS,//yes
				'HomeController.php' => $CONTROLLERS,//yes

				'EncryptCookies.php' => $MIDDLEWARE,//yes

				'Categories.php' => $MODELS,//yes

				'core.min.js' => $PUBLIC_JS,//yes

				'admin-styles.css' => $PUBLIC_CSS, //yes
				'styles.css' => $PUBLIC_CSS, //yes
				'switch-theme.js' => $PUBLIC_JS,//yes

				'bootstrap.min.css' => public_path('css' . $DS . 'bootstrap') . $DS, //Affected
				'bootstrap.min.js' => public_path('css' . $DS . 'bootstrap') . $DS, //Affected
				'bootstrap.bundle.min.js.map' => public_path('css' . $DS . 'bootstrap') . $DS, //Affected
				'bootstrap.min.css.map' => public_path('css' . $DS . 'bootstrap') . $DS, //Affected
				...
				'app.blade.php' => $VIEWS,//yes

				'view.blade.php' => $VIEWS_CAMPAIGNS,//yes

				'login.blade.php' => $VIEWS_AUTH,//yes
				'register.blade.php' => $VIEWS_AUTH,//yes
				'reset.blade.php' => $VIEWS_AUTH_PASSWORDS,//yes
				'email.blade.php' => $VIEWS_AUTH_PASSWORDS,//yes
				'embed.blade.php' => $VIEWS_AUTH_PASSWORDS,//yes
				'navbar.blade.php' => $VIEWS_INCLUDES,//yes
				'css_general.blade.php' => $VIEWS_INCLUDES,//yes
				'javascript_general.blade.php' => $VIEWS_INCLUDES,//yes
				'categories-listing.blade.php' => $VIEWS_INCLUDES,//yes
				'footer.blade.php' => $VIEWS_INCLUDES,//yes

				'home.blade.php' => $VIEWS_INDEX,//yes

				'donate.blade.php' => $VIEWS_DEFAULT,//yes
					
			];

			$filesAdmin = [
				'pwa.blade.php' => $VIEWS_ADMIN,//yes
				'layout.blade.php' => $VIEWS_ADMIN,//yes
			];
		...
		if ($version == '5.1') {
			...
			$files = [
				...
				'bootstrap.min.css' => public_path('css' . $DS . 'bootstrap') . $DS,//5.1
				'bootstrap.min.js' => public_path('css' . $DS . 'bootstrap') . $DS,//5.1
				'bootstrap.bundle.min.js.map' => public_path('css' . $DS . 'bootstrap') . $DS,//5.1
				'bootstrap.min.css.map' => public_path('css' . $DS . 'bootstrap') . $DS,//5.1
				'bootstrap-icons.css' => $PUBLIC_CSS,//5.1
				'bootstrap-icons.woff' => public_path('webfonts' . $DS . 'bootstrap') . $DS,//5.1
				'bootstrap-icons.woff2' => public_path('webfonts' . $DS . 'bootstrap') . $DS,//5.1					
			];
		...
		if ($version == '5.2') {
			...
			$files = [
				...
				'ViewServiceProvider.php' => $PROVIDERS,//5.2

				'Campaigns.php' => $MODELS,//5.2
				'Donations.php' => $MODELS,//5.2

				'StripeController.php' => $CONTROLLERS,

				'bootstrap.min.css' => public_path('css' . $DS . 'bootstrap') . $DS,//5.2
				'bootstrap.min.js' => public_path('css' . $DS . 'bootstrap') . $DS,//5.2
				'bootstrap.bundle.min.js.map' => public_path('css' . $DS . 'bootstrap') . $DS,//5.2
				'bootstrap.min.css.map' => public_path('css' . $DS . 'bootstrap') . $DS,//5.2				
			];

			$filesAdmin = [
				'donations.blade.php' => $VIEWS_ADMIN,//5.2
			];
		...
		if ($version == '5.3') {
			...
			$files = [
				...
				'InstallScriptController.php' => $CONTROLLERS,//5.3
				
				'footer.blade.php' => $VIEWS_INCLUDES,//5.3
			];
		...
		if ($version == '5.4') {
			...
			$files = [
				...
				'app.php' => $CONFIG,//5.4
				'image.php' => $CONFIG,//5.4

				'AdminController.php' => $CONTROLLERS,//5.4
				'CampaignsController.php' => $CONTROLLERS,//5.4
				'UserController.php' => $CONTROLLERS,//5.4
				
				'home.blade.php' => $VIEWS_INDEX,//5.4

				'donate.blade.php' => $VIEWS_DEFAULT,//5.4

				'core.min.js' => $PUBLIC_JS,//5.4
				'app-functions.js' => $PUBLIC_JS,//5.4
				'styles.css' => $PUBLIC_CSS,//5.4
			];

			$filesAdmin = [
				'edit-page.blade.php' => $VIEWS_ADMIN,//5.4
				'withdrawals.blade.php' => $VIEWS_ADMIN,//5.4
				'gallery.blade.php' => $VIEWS_ADMIN,//5.4
				'languages.blade.php' => $VIEWS_ADMIN,//5.4
				'members.blade.php' => $VIEWS_ADMIN,//5.4
				'reported-campaigns.blade.php' => $VIEWS_ADMIN,//5.4
				'pages.blade.php' => $VIEWS_ADMIN,//5.4
				'pwa.blade.php' => $VIEWS_ADMIN,//5.4
			];
		...
		if ($version == '5.5') {
			...
			$files = [
				...
				'withdrawals.blade.php' => $VIEWS_USERS,//5.5
				'campaigns.blade.php' => $VIEWS_USERS,//5.5

				'edit-rewards.blade.php' => $VIEWS_CAMPAIGNS,//5.5
			];
		...
		if ($version == '5.6') {
			...
			//============== Files ================//
			$files = [
				'composer.json' => $ROOT,//5.6
				'composer.lock' => $ROOT,//5.6

				'bootstrap.min.css' => public_path('css' . $DS . 'bootstrap') . $DS,//5.6
				'bootstrap.min.js' => public_path('css' . $DS . 'bootstrap') . $DS,//5.6
				'bootstrap.bundle.min.js.map' => public_path('css' . $DS . 'bootstrap') . $DS,//5.6
				'bootstrap.min.css.map' => public_path('css' . $DS . 'bootstrap') . $DS,//5.6	
			];

			$filesAdmin = [
				'dashboard.blade.php' => $VIEWS_ADMIN,//5.6
			];
