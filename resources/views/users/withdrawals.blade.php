              ...
              @foreach ($withdrawals as $withdrawal)
                <tr>
                  ...
                  <td>
                    ...
                    @if( $withdrawal->status != 'paid' )
                    <form action="{{ url('delete/withdrawal', $withdrawal->id) }}" method="POST" class="displayInline">
                      @csrf
                      <button type="button" data-url="{{ $withdrawal->id }}" class="btn btn-danger btn-sm deleteW">
                          {{ __('misc.delete') }}
                      </button> 
                    </form>
                @else
